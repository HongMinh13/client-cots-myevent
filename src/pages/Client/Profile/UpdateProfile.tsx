...
function UpdateProfile() {
  ...
  return (
    <div className="mb-8 flex flex-col items-center h-screen justify-center gap-8 bg-[url('https://i.ibb.co/99zGcN5/bg.png')]">
      <div className="${className} relative w-[50%] rounded-2xl bg-[#242424] bg-opacity-20 px-8 px-8 py-12 backdrop-blur-3xl md:w-full">
        <Typography.Title
