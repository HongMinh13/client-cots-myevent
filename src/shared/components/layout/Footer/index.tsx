...
export function FooterComponent() {
  return (
    <>
      <Footer className="relative top-[85px] mt-10  w-full items-center  bg-[#93BFCF] py-5">
              ...
              <Col md={12} sm={24}>
                ...
                <Row className={'my-4'}>
                  <FacebookSVG
                    width={64}
                    height={64}
                    className="mx-2 mb-2 cursor-pointer text-white hover:text-[#fcc45c]"
                  />
                  <TwitterSVG
                    width={64}
                    height={64}
                  ...
                  <InstagramSVG
                    width={64}
                    height={64}
                    className="mb-2 cursor-pointer  text-white hover:text-[#fcc45c]"
                  />
                </Row>
              </Col>
              <Col md={12} sm={24}>
